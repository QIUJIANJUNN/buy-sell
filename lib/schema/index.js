...
const orderbookByCurrencyPairDataFromBinance = currencyPair =>
  ...
  const BuyLowSellHigh = new GraphQLObjectType({
        ...
        fields: {
          ...
          SellingTolowestBuy: {type:GraphQLFloat},
          BuyingTOhighestSell: {type:GraphQLFloat},
  ...
  fields: {
    BuyLowSellHigh: {
      ...
      resolve:() => {
          return ({
            TokenPair: "ETH-USDT",
            SellingPlatform: "Binance",
            BuyingPlatform: "Cobinhood",
            SellingTolowestBuy: "800",
            BuyingTOhighestSell: "700",
            MaxAmount: 0.002,
            profitPercentage__: 0.125,
          })
      }
    },
    strategy: {
